...
public class ProductSpecs {
    ...
    //     return (root, query, criteriaBuilder) 
    //         -> criteriaBuilder.and(criteriaBuilder.gt(root.get(Product_.PRICE), min), criteriaBuilder.lt(root.get(Product_.PRICE), max));
    // }

    //case 6
    public static Specification<Product> matchMutiplePrice(double min, double max){
        return (root, query, criteriaBuilder) 
